...
struct UIEvent {
    enum class Type { STREAM_CONTENT, STREAM_REASONING, STREAM_TOOL_CALL, STREAM_END, USER_INPUT, USER_INPUT_QUEUED, ACTIVATE_QUEUED, STREAM_START, METRICS_UPDATE, TOOL_DISPLAY, DIFF_DISPLAY };
    Type type;
    std::string content;
