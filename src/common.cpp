...
- You have access to: read_file, write_file, edit_file, grep_search, exec_shell, list_directory, glob_search, and a task/calendar store (add_task, add_event, list_items, complete_item, remove_item).
